...
################################################################################
name_list = []
with open(r'C:\Users\xinyisong\Desktop\ICUI\POLLUTION_2\日数据汇总.csv', newline='',encoding='UTF-8-sig') as f:
...
result = result.drop(columns = ['工作日','O3','一氧化氮','一氧化碳','二氧化硫','氮氧化物','PM2.5','年','月','日','点位名称'])#有无其他污染物
