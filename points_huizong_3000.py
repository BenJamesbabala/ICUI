...
with open('监测点信息汇总_新_1000.csv', newline='',encoding='UTF-8-sig') as f:
...
################################长度#########################################
line_list = []
with open("普通道路_3000.txt", newline='',encoding='utf-8') as f:
    lines = f.readlines()
...
number.rename(columns={'长度':'普通道路_3000'}, inplace=True)#修改列名
...
data = data.fillna(0)
####################################导出######################################
data.to_csv('监测点信息汇总_3000_新.csv',index = False,encoding = 'utf_8_sig') 