...
l1, = plt.plot(x,[40]*351,color='purple',linewidth=2.0,linestyle='-')#The Annual Air Quality Standard of China/WHO
l2, = plt.plot(x,[80]*351,color='green',linewidth=2.0,linestyle='-')#The 24h Air Quality Standard of China
...
plt.ylim((0,120))
#plt.xlabel('I am x')
plt.ylabel('NO2 concentration (μg/m3)',fontsize=20)
...
#plt.text(-8,35,'40',fontdict={'size':8, 'color':'k'})#fontdict={'size':16, 'color':'r'}
#plt.text(-8,75,'80',fontdict={'size':8, 'color':'k'})
...
plt.legend(handles=[l1,l2,MM,DD],labels=['The Annual Air Quality Standard of China/WHO','The 24h Air Quality Standard of China',
           'Monthly average','Daily average'],loc='upper right') 
plt.show()